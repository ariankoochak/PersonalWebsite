...
export default function DatasDiv({ awardData, certificateData, experienceData, projectData }) {
    ...
    const handleActiveTabDatas = () => {
        switch (activeTab) {
            ...
            case "Projects ":
                return <ProjectsMainDatas data={projectData} />;
            case "Experiences ":
                return <ExperienceMainDatas data={experienceData} />;
            default:
